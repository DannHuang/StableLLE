...
from sgm.util import default, disabled_train, get_obj_from_str, instantiate_from_config, log_txt_as_img
...
class IRDiffusionEngine(pl.LightningModule):
    ...
    def get_input(self, batch, bs=None, val=False, text_cond=[''], resize_lq=True):
        ...
        cf_recon, struct_c = self.restorer(cropped_face_t)

        batch['cf_out'] = struct_c
